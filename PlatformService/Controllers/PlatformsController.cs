...
namespace PlatformService.Controllers
{
    ...
    public class PlatformsController : ControllerBase
    {
        ...
        {
            Console.WriteLine("Platform ById");
        ...
        [HttpPost]
        public async Task<ActionResult<PlatformCreateDto>> CreatePlatform(PlatformCreateDto platfromCreateDto)
        {
            ...
            {
                Console.WriteLine($"--> Could not send Synchorously {ex.Message}");
            }
